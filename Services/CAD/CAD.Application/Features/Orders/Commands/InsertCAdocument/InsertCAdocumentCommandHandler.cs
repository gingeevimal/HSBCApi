...
{
    public class InsertCAdocumentCommandHandler : IRequestHandler<InsertCAdocumentCommand, int>
    {
       ...
       // private readonly IEmailService _emailService;
        ...
        public async Task<int> Handle(InsertCAdocumentCommand request, CancellationToken cancellationToken)
        {
            var orderEntity = _mapper.Map<CAdocument>(request);
        ...
        //private async Task SendMail(CAdocument order)
        //{            
